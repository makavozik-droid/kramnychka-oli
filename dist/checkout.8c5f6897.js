...
})({"biqpM":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "e4c72cb28c5f6897";
"use strict";
...
},{}],"lKZ9T":[function(require,module,exports,__globalThis) {
...
(async function init() {
    ...
    cart.forEach((item)=>{
        ...
        total += rowTotal;
        lines.push(`${p.name} \u{2014} ${item.qty} \xd7 ${p.priceUAH} \u{433}\u{440}\u{43D} = ${rowTotal} \u{433}\u{440}\u{43D}`);
    });
    if (itemsField) itemsField.value = lines.join(" | ");
    if (totalField) totalField.value = (0, _domJs.formatUAH)(total);
})();

},{"./data.js":"a4kWt","./storage.js":"6iTkZ","./dom.js":"3crBc","./badge.js":"1md5T"}],"a4kWt":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3crBc":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./storage.js":"6iTkZ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["biqpM","lKZ9T"], "lKZ9T", "parcelRequire714f", {})

//# sourceMappingURL=checkout.8c5f6897.js.map
