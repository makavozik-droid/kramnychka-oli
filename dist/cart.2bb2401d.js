...
})({"4WZhV":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "651ffa1c2bb2401d";
"use strict";
...
function cartRow(product, qty) {
    const row = (0, _domJs.el)("div", {
        className: "cartRow"
    });
    const left = (0, _domJs.el)("div", {
        className: "cartRow__left"
    });
    const title = (0, _domJs.el)("div", {
        className: "cartRow__title",
        text: product.name
    });
    const meta = (0, _domJs.el)("div", {
        className: "cartRow__meta",
        text: `${product.category} \u{2022} ${(0, _domJs.formatUAH)(product.priceUAH)} / ${product.unit}`
    });
    left.append(title, meta);
    const right = (0, _domJs.el)("div", {
        className: "cartRow__right"
    });
    const qtyInput = (0, _domJs.el)("input", {
        className: "qty",
        type: "number"
    });
    qtyInput.min = "1";
    ...
    qtyInput.addEventListener("change", ()=>{
        (0, _storageJs.updateQty)(product.id, Number(qtyInput.value || 1));
        (0, _badgeJs.updateCartBadge)();
        render();
    });
    const removeBtn = (0, _domJs.el)("button", {
        className: "btnSecondary",
        text: "\u041F\u0440\u0438\u0431\u0440\u0430\u0442\u0438"
    });
    removeBtn.addEventListener("click", ()=>{
        (0, _storageJs.removeFromCart)(product.id);
        render();
    });
...
async function render() {
    ...
    if (cart.length === 0) {
        cartList.appendChild((0, _domJs.el)("p", {
            text: "\u041A\u043E\u0448\u0438\u043A \u043F\u043E\u0440\u043E\u0436\u043D\u0456\u0439. \u0414\u043E\u0434\u0430\u0439\u0442\u0435 \u0449\u043E\u0441\u044C \u0456\u0437 \u043A\u0430\u0442\u0430\u043B\u043E\u0433\u0443 \uD83D\uDE42"
        }));
    ...
    let products;
    try {
        products = await (0, _dataJs.loadProducts)();
    } catch (err) {
        cartList.appendChild((0, _domJs.el)("p", {
            text: "\u041D\u0435 \u0432\u0434\u0430\u043B\u043E\u0441\u044F \u0437\u0430\u0432\u0430\u043D\u0442\u0430\u0436\u0438\u0442\u0438 \u0442\u043E\u0432\u0430\u0440\u0438. \u041E\u043D\u043E\u0432\u0456\u0442\u044C \u0441\u0442\u043E\u0440\u0456\u043D\u043A\u0443."
        }));
        totalPriceEl.textContent = "0 \u0433\u0440\u043D";
        return;
    }
    ...
    totalPriceEl.textContent = (0, _domJs.formatUAH)(total);
}
...
},{"./storage.js":"6iTkZ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["4WZhV","j7uuE"], "j7uuE", "parcelRequire714f", {})

//# sourceMappingURL=cart.2bb2401d.js.map
